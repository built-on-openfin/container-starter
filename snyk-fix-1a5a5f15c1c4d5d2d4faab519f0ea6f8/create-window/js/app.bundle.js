...
async function openManifestApplicationWindow() {
    try {
        await fin.Application.startFromManifest("https://built-on-openfin.github.io/container-starter/snyk-fix-1a5a5f15c1c4d5d2d4faab519f0ea6f8/create-window/app.fin.json");
...
async function openDataWindow() {
    const winOption = {
        ...
        defaultWidth: 800,
        defaultHeight: 800,
        url: "https://built-on-openfin.github.io/container-starter/snyk-fix-1a5a5f15c1c4d5d2d4faab519f0ea6f8/create-window/html/window.html",
        frame: true,
        autoShow: true,
        customData: {
            dateNow: Date.now()
