...
async function launchPlatform() {
    try {
        await fin.System.launchManifest("https://built-on-openfin.github.io/container-starter/snyk-fix-1a5a5f15c1c4d5d2d4faab519f0ea6f8/use-channel-api-issue-commands-to-a-platform/platform.fin.json");
    }
    catch (error) {
...
async function requestView() {
    try {
        ...
        lastCreatedView = await channelClient.dispatch("createView", {
            viewOptions: {
                url: "https://built-on-openfin.github.io/container-starter/snyk-fix-1a5a5f15c1c4d5d2d4faab519f0ea6f8/use-channel-api-issue-commands-to-a-platform/html/app.html",
                customData: {
                    dateNow: Date.now()
                }
            }
