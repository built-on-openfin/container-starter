...
async function initDom() {
    ...
    await application.setTrayIcon("https://built-on-openfin.github.io/container-starter/v44/integration-excel/favicon.ico");
    let visible = false;
    let win;
            ...
            if (!win) {
                ...
                const winOption = {
                    ...
                    defaultHeight: foundMonitor
                        ...
                        : undefined,
                    url: "https://built-on-openfin.github.io/container-starter/v44/integration-excel/views/excel.html",
                    frame: false,
                    autoShow: true,
                    alwaysOnTop: true,
                    resizable: false,
