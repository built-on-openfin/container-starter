...
```javascript
"trustedAppConfigs": {
        "value": "This value will be provided by Here once the relevant information has been provided.",
        "signature": {
            "win": "This value will be provided by Here once the relevant information has been provided.",
            "mac": "This value will be provided by Here once the relevant information has been provided."
        }
    },
```
...
You will need to contact your Here account manager and say you want to enable licensed codecs for your project.

You will then need to provide Here with the following pieces of information:
...
This information will then go through a process at Here and you will be provided with the relevant trustedAppConfig.
...
This is an example of how to use HERE manifests to enable licensed codecs. Its purpose is to provide an example and suggestions. **DO NOT** assume that it contains production-ready code. Please use this as a guide and provide feedback. Thanks!
