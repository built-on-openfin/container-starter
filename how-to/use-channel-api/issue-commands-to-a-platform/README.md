...
The application issuing the command is a traditional HERE window application but could just as easily have been a Java or .NET application.

The main logic for the creation of the command channel can be found in [client/src/provider.ts](client/src/provider.ts).

## How it Works

The HERE window application launches and exposes three buttons.

- One button launches the target platform that complements the HERE window app and connects to the channel
...
4. Start the HERE Window application.
...
1. The HERE Window application launches

2. A button on the HERE Window Application launch the platform and connect to the channel

3. A second button on the HERE Window Application issues a createView command.

4. A third button on the HERE Window Application issues a createView command and passes information related to the last launched view (which window it was attached to).
