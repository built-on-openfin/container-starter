...
async function openManifestApplicationWindow() {
    try {
        await fin.Application.startFromManifest("https://built-on-openfin.github.io/container-starter/dev/ameet/log-uploader-api/create-window/app.fin.json");
...
async function openDataWindow() {
    const winOption = {
        ...
        defaultWidth: 800,
        defaultHeight: 800,
        url: "https://built-on-openfin.github.io/container-starter/dev/ameet/log-uploader-api/create-window/html/window.html",
        frame: true,
        autoShow: true,
        customData: {
            dateNow: Date.now()
