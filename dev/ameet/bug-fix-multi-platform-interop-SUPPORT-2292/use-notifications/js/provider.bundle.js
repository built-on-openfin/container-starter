...
const NOTIFICATION_SOUND_URL = "https://built-on-openfin.github.io/container-starter/dev/ameet/bug-fix-multi-platform-interop-SUPPORT-2292/use-notifications/assets/notification.mp3";
...
async function showCustomNotification() {
    const notification = {
        ...
        templateData: {
            ...
            d11: "650",
            d12: "750",
            exampleImageUrl: "https://built-on-openfin.github.io/container-starter/dev/ameet/bug-fix-multi-platform-interop-SUPPORT-2292/use-notifications/images/example.png",
