...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const baseUrl = "https://built-on-openfin.github.io/container-starter/dev/ameet/readme-log-uploader/use-platform-apply-snapshot";
