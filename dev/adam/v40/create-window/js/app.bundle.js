...
async function openManifestApplicationWindow() {
    try {
        await fin.Application.startFromManifest("https://built-on-openfin.github.io/container-starter/dev/adam/v40/create-window/app.fin.json");
...
async function openDataWindow() {
    const winOption = {
        ...
        defaultWidth: 800,
        defaultHeight: 800,
        url: "https://built-on-openfin.github.io/container-starter/dev/adam/v40/create-window/html/window.html",
        frame: true,
        autoShow: true,
        customData: {
            dateNow: Date.now()
